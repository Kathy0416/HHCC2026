...
function initSchema() {
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS hardware_events (
      ...
      event_utc_ms INTEGER,
      boot_id INTEGER,
      time_quality INTEGER NOT NULL DEFAULT 0,
      status INTEGER NOT NULL DEFAULT 1,
      pre_count INTEGER NOT NULL DEFAULT 0,
    ...
    CREATE TABLE IF NOT EXISTS hardware_samples (
      ...
      utc_epoch_ms INTEGER,
      boot_id INTEGER,
      sampling_mode INTEGER NOT NULL DEFAULT 0,
      time_quality INTEGER NOT NULL DEFAULT 0,
      light_lux REAL,
      temperature_c REAL,
      humidity_percent REAL,
      noise_db_spl REAL,
      valid_mask INTEGER NOT NULL DEFAULT 0,
      UNIQUE(event_id, sample_index),
