(function (root, factory) {
  ...
  const keys = {
    en: {
      ...
      'health.chart.steps': 'Steps',
      'health.chart.environment': 'Temperature & humidity',
      'health.chart.light': 'Light intensity',
      ...
      'health.source.backend': 'Backend DB',
      'health.source.local': 'Local (offline)',
    ...
    'zh-CN': {
      ...
      'health.chart.steps': '步数',
      'health.chart.environment': '温度与湿度',
      'health.chart.light': '光照强度',
      ...
      'health.source.backend': '后端数据库',
      'health.source.local': '本地(离线)',
      'health.common.yes': '是',
      'health.common.no': '否',
  ...
  const api = {
    ...
    'zh-CN': {
      ...
      , invalidProvider: '目前仅支持 Health Connect', invalidHealthPayload: '健康数据格式无效', invalidTimezone: '时区无效', invalidTimestamp: '健康数据时间戳无效', invalidConnection: '连接编号无效', connectionNotFound: '未找到健康数据连接', connectionInactive: '此健康连接已断开，请先在安卓应用中重新连接', invalidRange: '时间范围只能为 7、30 或 90 天', invalidReadings: '读数数据格式无效', tooManyReadings: '单次请求读数过多'
    }
  };
