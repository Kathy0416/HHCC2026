(function (root, factory) {
  ...
  const keys = {
    en: {
      ...
      'health.esp32.title': 'Environment data',
      ...
      'health.esp32.hint': 'Read the ESP32 environment database on the same network and save it securely to this account.',
      'health.esp32.noData': 'No environment data has been synced yet.',
      'health.esp32.updatedAt': 'Latest sample: {{time}}',
    ...
    'zh-CN': {
      ...
      'health.esp32.title': '环境数据',
      'health.esp32.endpoint': 'ESP32 数据地址',
      'health.esp32.endpointPlaceholder': 'http://esp32.local/data',
      'health.esp32.sync': '同步 ESP32 数据',
      'health.esp32.syncing': '正在同步…',
      'health.esp32.hint': '读取同一网络中的 ESP32 环境数据库，并安全保存到当前账号。',
      'health.esp32.noData': '尚未同步环境数据。',
      'health.esp32.updatedAt': '最新样本：{{time}}',
