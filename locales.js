(function (root, factory) {
  ...
  const keys = {
    en: {
      ...
      'health.metric.migraineDuration': 'Migraine duration',
      'health.metric.durationMinutes': 'Duration (minutes)',
      'health.metric.vitals': 'Blood oxygen & heart rate',
      'health.metric.spo2': 'Blood oxygen (%)',
      'health.metric.heartRate': 'Heart rate (bpm)',
      'health.metric.save': 'Save',
      'health.metric.saved': 'Saved',
      ...
      'health.kpi.migraineDuration': 'Average migraine duration',
      ...
      'health.history.migraineDuration': 'Migraine duration',
    ...
    'zh-CN': {
      ...
      'health.metric.migraineDuration': '偏头痛时长',
      'health.metric.durationMinutes': '时长（分钟）',
      'health.metric.vitals': '血氧与心率',
      'health.metric.spo2': '血氧（%）',
      'health.metric.heartRate': '心率（bpm）',
      'health.metric.save': '保存',
      'health.metric.saved': '已保存',
      ...
      'health.kpi.migraineDuration': '平均偏头痛时长',
      ...
      'health.history.migraineDuration': '偏头痛时长',
  ...
  const api = {
    ...
    'zh-CN': {
      ...
      , invalidProvider: '目前仅支持 Health Connect', invalidHealthPayload: '健康数据格式无效', invalidTimezone: '时区无效', invalidTimestamp: '健康数据时间戳无效', invalidConnection: '连接编号无效', connectionNotFound: '未找到健康数据连接', connectionInactive: '此健康连接已断开，请先在安卓应用中重新连接', invalidRange: '时间范围只能为 7、30 或 90 天', invalidMetricValue: '指标数值无效'
    }
  };
